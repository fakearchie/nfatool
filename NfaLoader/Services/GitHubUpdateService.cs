...
{
    public const string RepositoryUrl = "https://github.com/fakearchie/nfatool";
    public const string ReleasesUrl = $"{RepositoryUrl}/releases";
    private const string LatestMetadataUrl = $"{RepositoryUrl}/releases/latest/download/latest.json";
    ...
    private static HttpClient CreateHttpClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.ParseAdd("nfa-pub-loader-updater");
    ...
    private static string BuildUrl(GitHubProxySite site, string url)
    {
        ...
        // These proxies use the "prefix + full GitHub URL" pattern and only proxy github.com links.
...
// JsonSerializerDefaults.Web keeps the old reflection-based serializer behaviour: camelCase + case-insensitive,
// and the latest.json fields (version/tag/artifactName...) rely on that naming policy.
